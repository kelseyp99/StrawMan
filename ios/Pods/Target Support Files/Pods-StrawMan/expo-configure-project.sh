...
with_node \
  ...
  --target "/Users/tinman/Projects/StrawMan/ios/Pods/Target Support Files/Pods-StrawMan/ExpoModulesProvider.swift" \
  --entitlement "/Users/tinman/Projects/StrawMan/ios/StrawMan/StrawMan.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-document-picker" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-media-library" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-updates" "expo-web-browser"
