...
exports.buyCandidateCoin = void 0;
...
exports.buyCandidateCoin = (0, https_1.onCall)(async (request) => {
    ...
    const functionArgs = [
        (0, clarity_1.uintCV)(candidateId),
        (0, clarity_1.principalCV)(buyer),
        (0, clarity_1.uintCV)(amount),
        (0, clarity_1.uintCV)(price)
    ];
    // Choose network
    const network = new network_1.StacksTestnet(); // or StacksMainnet()
    // Prepare transaction
    const txOptions = {
    ...
    try {
        const tx = await (0, transactions_1.makeContractCall)(txOptions);
